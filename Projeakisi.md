...
| **F2-04** | Randevu İptal Yönetimi | Randevuların hasta veya doktor tarafından iptal edilebilmesi ve durum güncellemeleri | Orta | ✅ Tamamlandı |
...
| Görev Kodu | Modül Adı | İçerik | Öncelik | Durum |
|:---:|---|---|:---:|:---:|
| **F3-01** | Canlı Mesajlaşma (Chat) | Hasta-Doktor arası mesajlaşma, tahlil/dosya/görsel gönderme | Yüksek | ✅ Tamamlandı |
| **F3-02** | Gelişmiş Video Konferans | Jitsi bağlantısına süre takibi ve ekran paylaşımı ekleme | Yüksek | ✅ Tamamlandı |
| **F3-03** | Tahlil Sonuç Bildirimleri | Hastanın laboratuvar sonucu çıktığında sistem üzerinden anlık bildirim gönderme | Orta | ✅ Tamamlandı |
...
| **F5-02** | Hesap Güvenliği & Denetim Günlükleri | Audit log (KVKK), Brute-Force koruması (5 başarısız girişte kilitlenme) | Yüksek | ✅ Tamamlandı |
